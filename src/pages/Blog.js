                ...
                <div className="w-full sm:w-3/4 pl-8 mt-2">
                    <div className="bg-gray-800 text-white p-4">
                        ...
                        <div className="mb-6">
                            ...
                            <p className="text-sm mb-2">Published on: <span className="text-gray-400">January 9, 2023</span></p>
                        ...
                        <div className="mb-6">
                            ...
                            <p className="text-sm mb-2">Published on: <span className="text-gray-400">May 25, 2023</span></p>
                        ...
                        <div className="mb-6">
                            ...
                            <p className="text-sm mb-2">Published on: <span className="text-gray-400">April 2, 2024</span></p>
